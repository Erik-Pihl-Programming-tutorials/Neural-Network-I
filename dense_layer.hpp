...
struct dense_layer
{
   ...
   * 
   *                - reference: Referens till referensvärden från träningsdatan.
   ********************************************************************************/
   ...
   * 
   *           - input        : Insignaler som används för att justera vikterna.
...
private:
   ...
   * 
   *        - data   : Referens till vektorn vars innehåll skall skrivas ut.
